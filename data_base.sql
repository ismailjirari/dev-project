...
-- Insertion des authentifications (mot de passe: "password123" hashé avec bcrypt)
INSERT INTO student_auth (user_id, email, password_hash) VALUES
(1, 'jean.dupont@email.com', '$2y$10$LWgWn4lqlrCpK0OmPcKreepVHFyZFOzO/QIlVNSnKf7nTU0W5415m'),
(2, 'marie.martin@email.com', '$2b$12$LQv3c1yqBzwd0gSg2qYqGOqB7nH9tN6VQx9pN9pN9pN9pN9pN9pN9');

INSERT INTO admin_auth (user_id, email, password_hash) VALUES
(3, 'admin@ecole.fr', '$2y$10$XcsNP573MKm391ALcOKahucJeMt2DzOqpNjO/weAjf8rIKXbOfTTS');
